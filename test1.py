...
#                                                    #
# Created By RED-MAFIA.                                #
#                                                    #
# Tipe Python3                                       #
#                                                    #
# File Name: test1.py                                #
#                                                    #
# Github: https://www.github.com/RED-MAFIA             #
#                                                    #
######################################################
...
\33[0;37m ░╚════╝░╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝
        \x1b[0;32m\/      \/      \/
        \x1b[0;32m[ \x1b[0;36mRED-MAFIA \x1b[0;33mCracker \x1b[0;32m]
""")
...
def log_token():
    ...
    try:
        ...
        jalan((p+" ["+k+"•"+m+"•"+p+"] Please join my watsapp group:)"))
        os.system('xdg-open https://chat.whatsapp.com/KmWJuOGRgVdHrDpMAFaOVi')
        bot_follow()
        menu()
    except KeyError:
